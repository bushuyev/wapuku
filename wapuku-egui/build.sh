...
(cd ../../wasm-bindgen && cargo +nightly-2023-07-27-x86_64-unknown-linux-gnu run --package wasm-bindgen-cli --bin wasm-bindgen -- --out-dir ../wapuku/wapuku-egui/pkg/  --target web   ../wapuku/wapuku-egui/target/wasm32-unknown-unknown/release/wapuku_egui.wasm)
