...
impl Data for PolarsData {
    ...
    fn build_grid(&self, property_x: PropertyRange, property_y: PropertyRange, x_n: u8, y_n: u8, group_volume_property: &str) -> GroupsGrid {
        ...
        for row in 0..df.height() {
            ...
            debug!("adding y={:?} x={:?} row_vec[2..]={:?}", row_vec[1], row_vec[0], row_vec[2..].to_vec());
...
mod tests {
    ...
    fn test_polars_data_1x3x3(){
        ...
        **/
        ...
        let mut grid = x_property_1_y_property_2_to_3_x_3_data(df);
        let data = grid.data();


        
        assert_eq!(data[0][0].volume(), 1);
        assert_eq!(data[0][1].volume(), 1);
        assert_eq!(data[0][2].volume(), 1);

        assert_eq!(data[1][0].volume(), 1);
        assert_eq!(data[1][1].volume(), 1);
        assert_eq!(data[1][2].volume(), 1);

        assert_eq!(data[2][0].volume(), 1);
        assert_eq!(data[2][1].volume(), 1);
        assert_eq!(data[2][2].volume(), 1);
    ...
    fn test_polars_data_1x2x3(){
        ...
        **/
        ...
        assert_eq!(data[0][0].volume(), 0);
        assert_eq!(data[0][1].volume(), 1);
        assert_eq!(data[0][2].volume(), 1);
        
        assert_eq!(data[1][0].volume(), 0);
        assert_eq!(data[1][1].volume(), 1);
        assert_eq!(data[1][2].volume(), 1);
        
        assert_eq!(data[2][0].volume(), 0);
        assert_eq!(data[2][1].volume(), 1);
        assert_eq!(data[2][2].volume(), 1);
    ...
    fn test_polars_data_1x3x2(){
        ...
        **/
        ...
        let mut gird = x_property_1_y_property_2_to_3_x_3_data(df);
        let data = gird.data();


        assert_eq!(data[0][0].volume(), 0);
        assert_eq!(data[0][1].volume(), 0);
        assert_eq!(data[0][2].volume(), 0);
    ...
    fn test_polars_data_1x4x3(){
        ...
        **/
        ...
        assert_eq!(data[0][0].volume(), 1);
        assert_eq!(data[0][1].volume(), 2);
        assert_eq!(data[0][2].volume(), 1);

        assert_eq!(data[1][0].volume(), 1);
        assert_eq!(data[1][1].volume(), 2);
        assert_eq!(data[1][2].volume(), 1);

        assert_eq!(data[2][0].volume(), 1);
        assert_eq!(data[2][1].volume(), 2);
        assert_eq!(data[2][2].volume(), 1);
    ...
    fn x_property_1_y_property_2_to_3_x_3_data(mut df: DataFrame) -> GroupsGrid {
